...
# This forces it to look at the .env file in your root folder
...
# SECRET_KEY = config("SECRET_KEY")
SECRET_KEY = 'django-insecure-6y!6n(btt*%m1yq-=k96v_8+9%nw!+vr!2687g8)d@9=-y%q_v'
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                'stories.context_processors.cat_func',
                'stories.context_processors.post_func',
            ],
        },
    },
]
